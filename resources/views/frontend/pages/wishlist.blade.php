									...
									<div class="product-gallery">
										<div class="quickview-slider-active">
											<div class="single-slider">
												<img src="{{ asset('public') }}/images/modal1.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="{{ asset('public') }}/images/modal2.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="{{ asset('public') }}/images/modal3.jpg" alt="#">
											</div>
											<div class="single-slider">
												<img src="{{ asset('public') }}/images/modal4.jpg" alt="#">
											</div>
										</div>
									</div>
								<!-- End Product slider -->
